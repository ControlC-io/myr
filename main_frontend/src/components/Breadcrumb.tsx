...
const BREADCRUMB_MAP: Record<string, BreadcrumbItem[]> = {
  ...
  '/intervention':           [{ label: 'Dashboard', href: '/dashboard' }, { label: 'Ticketing' }, { label: 'Interventions' }],
  '/invoice':                [{ label: 'Dashboard', href: '/dashboard' }, { label: 'Administrative' }, { label: 'Invoices' }],
  '/payment-information':    [{ label: 'Dashboard', href: '/dashboard' }, { label: 'Administrative' }, { label: 'Payment Information' }],
  '/customer-information':   [{ label: 'Dashboard', href: '/dashboard' }, { label: 'Administrative' }, { label: 'Customer Information' }],
  ...
  '/orders':                 [{ label: 'Dashboard', href: '/dashboard' }, { label: 'Sales' }, { label: 'Orders' }],
  '/orders/:id':             [{ label: 'Dashboard', href: '/dashboard' }, { label: 'Sales' }, { label: 'Orders', href: '/orders' }, { label: 'Detail' }],
